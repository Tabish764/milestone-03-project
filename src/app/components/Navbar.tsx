...
const Navbar = () => {
  return (
    <div className=" border-b-2 shadow-xl shadow-red-500/50 backdrop-blur-md    border-red-500 py-4 flex items-center px-4 w-full"> 
        ...
        <h1 className="text-red-500 text-sm md:text-2xl">RenderBoost</h1>
      <div className=" max-w-7xl font-bold mx-auto justify-end items-center text-lg w-full flex">
        <div className="flex gap-5 text-sm md:text-lg items-center">
